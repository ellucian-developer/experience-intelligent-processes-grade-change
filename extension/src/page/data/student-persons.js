...
export const resourceName = process.env.PIPELINE_GET_STUDENT_INFO;
export async function fetchStudentInformation({ authenticatedEthosFetch, queryKeys, signal }) {
    if (!process.env.PIPELINE_GET_STUDENT_INFO) {
        const message = 'PIPELINE_GET_STUDENT_INFO is not defined in environment!!!';
